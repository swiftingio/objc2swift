...
extension UIView {
     ...
     * them to the view*/
//    class func addConstraints(fromStrings strings: [Any],
//                              withMetrics metrics: [AnyHashable: Any],
//                              andViews views: [AnyHashable: Any],
//                              to view: UIView) {
//        var constraints = [Any]()
...
//        return self.init(autolayout: true)
//        //var view: UIView = self.init(frame: CGRect.zero)
